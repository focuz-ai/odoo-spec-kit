---
description:
  Especificación técnica de la API de Odoo 18.0, incluyendo endpoints de JSON-RPC,
...
18.0. Odoo expone servicios nativos mediante **XML-RPC** y **JSON-RPC**, además de
