---
description:
  Documentación y ejemplo del modelo de datos de Contabilidad (Accounting) en Odoo 17.0,
...
Contabilidad (`account`) de Odoo 17.0, sirviendo de referencia de diseño técnico para la
...
2. **Multicompañía Estricto**: Odoo 17.0 valida rigurosamente los accesos multicompañía.
